...
<body>
	...
	<div id="container">
		<div id="contents">
			...
			<c:if test="${selectCnt == 1 }">	<!-- 비밀번호가 일치하는 경우 -->
				<!-- 상단 중앙2 시작 -->
				<div id="section2">
							...
							<form name="modifyform" action="${path }/modifyCustomerAction.do" method="post">
								<table>
									...
									<tr>
										<th> 아이디(수정불가능) </th>		
										<td>
											<input type="text" class="input" name="customerID" size="22" value="${dto.ac_id}" readonly style="color: red"/>
										</td>
									</tr>	
									...
									<tr>
										<td colspan="3" style="border-bottom: none">
											...
											<div align="right">
												...
												<input type="button" value="회원탈퇴" onclick="window.location='${path}/deleteCustomerAction.do'">
